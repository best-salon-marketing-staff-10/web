        ...
        <div className="tablet-content">
          <div className="tablet-nd">
            ...
            <div className="tablet-image-1">
              <img className="tablet-image-1-1" src={thongTinTiem1.image1Setmore} />
            </div>
            ...
            <div className="tablet-image-6">
              <img className="tablet-image-6-1" src={thongTinTiem1.image6Setmore} />
            </div>
            ...
            <div className="tablet-image-text">
              ...
              <img className="tablet-image-7" src={thongTinTiem1.image10Setmore} />
            </div>
            <div className="tablet-image-text-2">
              ...
              <img className="tablet-image-8" src={thongTinTiem1.image8Setmore} />
            </div>
            <div className="tablet-image-text-3">
              ...
              <img className="tablet-image-9" src={thongTinTiem1.image9Setmore} />
            </div>
            ...
            <div className="tablet-text-image">
              <div className="tablet-text-22">
                ...
                <img className="tablet-image-10" src={thongTinTiem1.image9Setmore} />
              </div>
            </div>
            <div className="tablet-text-image-2">
              <div className="tablet-text-23">
                Và sau đó mới chỉnh mục <b>Starts</b> như hình
                <img className="tablet-image-11" src={thongTinTiem1.image8Setmore} />
              </div>
            </div>
            ...
            <div className="tablet-image-12">
              <img className="tablet-image-12-1" src={thongTinTiem1.image11Setmore} />
            </div>
            <div className="tablet-text-25">
              Bước 9: Lặp lại với tất cả các nhân viên.
            </div>
            <div className="tablet-image-13">
              <img className="tablet-image-13-1" src={thongTinTiem1.image12Setmore} />
            </div>
          </div>
        </div>
